...
namespace Doctor
{
    public partial class FormRptTreatsOfPatient : Form
    {
        ...
        public FormRptTreatsOfPatient(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textboxPatientID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   pattrtID, pattrtDate, pattrtName " +
                                          "FROM     tblPatientTreats   " +
                                          "WHERE    pattrtPatiId = " + patientID + " " +
                                          "ORDER BY pattrtID";
        ...
        private void FormRptTreatsOfPatient_Load(object sender, EventArgs e)
        {

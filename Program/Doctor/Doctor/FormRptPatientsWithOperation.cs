...
namespace Doctor
{
    public partial class FormRptPatientsWithOperation : Form
    {
        ...
        public FormRptPatientsWithOperation(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textbox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patoprPatiID  " +
                                          "FROM     tblPatientOperations   " +
                                          "WHERE    patoprName = \"" + regName + "\" " +
        ...
        private void FormRptPatientsWithOperation_Load(object sender, EventArgs e)
        {

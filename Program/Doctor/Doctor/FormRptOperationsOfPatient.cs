...
namespace Doctor
{
    public partial class FormRptOperationsOfPatient : Form
    {
        ...
        public FormRptOperationsOfPatient(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textboxPatientID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patoprID, patoprDate, patoprName " +
                                          "FROM     tblPatientOperations   " +
                                          "WHERE    patoprPatiID = " + patientID + " " +
                                          "ORDER BY patoprID";
        ...
        private void FormRptOperationsOfPatient_Load(object sender, EventArgs e)
        {

...
namespace Doctor
{
    public partial class FormRptDiseasesByDate : Form
    {
        ...
        public FormRptDiseasesByDate(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patdssPatiID, patdssName, patdssDate " +
                                          "FROM     tblPatientDiseases   " +
                                          "WHERE    patdssDate BETWEEN #" + dateTimePicker1.Value.ToShortDateString() + "#  AND #" + dateTimePicker2.Value.ToShortDateString() + "#  " +
                                          "ORDER BY patdssID";

...
namespace Doctor
{
    public partial class FormRptPatientsWithTreat : Form
    {
        ...
        public FormRptPatientsWithTreat(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textbox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   pattrtPatiId  " +
                                          "FROM     tblPatientTreats   " +
                                          "WHERE    pattrtName = \"" + regName + "\" " +
        ...
        private void FormRptPatientsWithTreat_Load(object sender, EventArgs e)
        {

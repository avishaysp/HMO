...
namespace Doctor
{
    public partial class FormRptPatientsWithDrug : Form
    {
        ...
        public FormRptPatientsWithDrug(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textbox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patdrgPatiID  " +
                                          "FROM     tblPatientDrugs   " +
                                          "WHERE    patdrgName = \"" + regName + "\" " +
        ...
        private void FormRptPatientsWithDrug_Load(object sender, EventArgs e)
        {

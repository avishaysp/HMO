...
namespace Doctor
{
    public partial class FormRptDrugsOfPatient : Form
    {
        ...
        public FormRptDrugsOfPatient(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textboxPatientID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patdrgID, patdrgDate, patdrgName " +
                                          "FROM     tblPatientDrugs   " +
                                          "WHERE    patdrgPatiID = " + patientID + " " +
                                          "ORDER BY patdrgID";
        ...
        private void FormRptDrugsOfPatient_Load(object sender, EventArgs e)
        {

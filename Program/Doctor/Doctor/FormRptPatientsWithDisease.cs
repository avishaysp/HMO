...
namespace Doctor
{
    public partial class FormRptPatientsWithDisease : Form
    {
        ...
        public FormRptPatientsWithDisease(OleDbConnection dataConnection, bool isManager)
        {
            InitializeComponent();
        ...
        private void textbox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                datacommand.CommandText = "SELECT   patdssPatiID  " +
                                          "FROM     tblPatientDiseases   " +
                                          "WHERE    patdssName = \"" + regName + "\" " +
        ...
        private void FormRptPatientsWithDisease_Load(object sender, EventArgs e)
        {
